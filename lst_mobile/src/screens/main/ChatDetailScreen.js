...
const styles = StyleSheet.create({
  ...
  bubble: { alignSelf: 'flex-start', flexGrow: 0, flexShrink: 1, maxWidth: '84%', minWidth: 96, paddingHorizontal: 13, paddingTop: 9, paddingBottom: 8, borderRadius: 17, borderWidth: StyleSheet.hairlineWidth },
  emojiBubble: { minWidth: 100 },
