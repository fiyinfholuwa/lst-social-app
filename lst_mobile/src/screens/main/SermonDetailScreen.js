    ...
    >
      ...
      <View style={[styles.sermonCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
        ...
        <View style={[styles.actionBar, { borderTopColor: theme.border }]}>
          <TouchableOpacity style={[styles.actionButton, sermon.likedByCurrentUser && { backgroundColor: theme.primarySoft }]} onPress={toggleLike}><AppIcon name="heart" solid={sermon.likedByCurrentUser} size={17} color={sermon.likedByCurrentUser ? theme.accent : theme.secondaryText} /><Text style={[styles.actionButtonText, { color: sermon.likedByCurrentUser ? theme.primary : theme.text }]}>{sermon.likes} {sermon.likes === 1 ? 'like' : 'likes'}</Text></TouchableOpacity>
