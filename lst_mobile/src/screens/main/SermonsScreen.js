...
export default function SermonsScreen({ navigation }) {
  ...
  const Header = () => <View>
    <View style={styles.libraryIntro}>
      <Text style={[styles.libraryTitle, { color: theme.text }]}>Messages for your journey</Text>
      <Text style={[styles.libraryText, { color: theme.secondaryText }]}>Listen, reflect, and grow in every season.</Text>
    </View>
...
const styles = StyleSheet.create({
  ...
  screen: { flex: 1 }, content: { paddingHorizontal: 14 }, emptyContent: { flexGrow: 1 }, libraryIntro: { marginTop: -8, marginBottom: 9, paddingHorizontal: 3 }, libraryTitle: { fontSize: 15, lineHeight: 20, fontWeight: '900' }, libraryText: { fontSize: 10.5, lineHeight: 15, marginTop: 2 }, searchRow: { marginBottom: 8, flexDirection: 'row', alignItems: 'center', gap: 8 }, quickSearch: { flex: 1, height: 44, borderWidth: 1, borderRadius: 15, paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', gap: 8 }, quickSearchInput: { flex: 1, height: 42, fontSize: 12 }, filterButton: { width: 44, height: 44, borderRadius: 15, borderWidth: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }, badge: { position: 'absolute', top: -5, right: -5, minWidth: 18, height: 18, paddingHorizontal: 4, borderRadius: 9, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E5E7EB', alignItems: 'center', justifyContent: 'center' }, badgeText: { color: '#111827', fontSize: 9, fontWeight: '900' }, quickCategories: { gap: 6, paddingBottom: 10, paddingRight: 12 }, quickCategory: { height: 31, borderRadius: 16, borderWidth: 1, paddingHorizontal: 11, alignItems: 'center', justifyContent: 'center' }, quickCategoryText: { fontSize: 10, fontWeight: '800' }, featuredWrap: { marginBottom: 10 }, featured: { minHeight: 152, borderRadius: 20, padding: 14, overflow: 'hidden' }, featuredTop: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, featuredLabel: { flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 8, height: 23, borderRadius: 12, backgroundColor: 'rgba(255,255,255,.16)' }, featuredLabelText: { color: '#FFFFFF', fontSize: 8, letterSpacing: .8, fontWeight: '900' }, featuredPlay: { width: 34, height: 34, borderRadius: 17, backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' }, featuredTitle: { color: '#FFFFFF', fontSize: 18, lineHeight: 22, fontWeight: '900', marginTop: 10, maxWidth: '92%' }, featuredSpeaker: { color: 'rgba(255,255,255,.9)', fontSize: 9.5, fontWeight: '800', marginTop: 4 }, featuredDescription: { color: 'rgba(255,255,255,.72)', fontSize: 9.5, lineHeight: 14, marginTop: 5 }, featuredFooter: { flexDirection: 'row', alignItems: 'center', marginTop: 10 }, featuredStats: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 4 }, featuredStatText: { color: 'rgba(255,255,255,.78)', fontSize: 9, fontWeight: '700', marginRight: 6 }, featuredListen: { color: '#FFFFFF', fontSize: 10, fontWeight: '900', marginRight: 5 }, card: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderRadius: 17, padding: 10, marginBottom: 8, gap: 9 }, playIcon: { width: 40, height: 40, borderRadius: 13, alignItems: 'center', justifyContent: 'center' }, copy: { flex: 1, minWidth: 0 }, title: { fontSize: 12.5, lineHeight: 17, fontWeight: '800' }, meta: { fontSize: 8.5, fontWeight: '900', textTransform: 'uppercase', letterSpacing: .4, marginTop: 3 }, speaker: { fontSize: 9.5, marginTop: 2 }, description: { fontSize: 9, lineHeight: 14, marginTop: 3 }, engagement: { flexDirection: 'row', gap: 9, marginTop: 5 }, engagementItem: { flexDirection: 'row', alignItems: 'center', gap: 3 }, engagementText: { fontSize: 8.5, fontWeight: '700' }, cardArrow: { width: 28, height: 28, borderRadius: 9, alignItems: 'center', justifyContent: 'center' }, playButton: { height: 34, borderRadius: 11, paddingHorizontal: 11, flexDirection: 'row', alignItems: 'center', gap: 5 }, playText: { color: '#FFFFFF', fontSize: 11, fontWeight: '800' }, loader: { paddingVertical: 30 }, empty: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 70 }, emptyIcon: { width: 55, height: 55, borderRadius: 18, alignItems: 'center', justifyContent: 'center' }, emptyTitle: { fontSize: 17, fontWeight: '800', marginTop: 13 }, emptyText: { fontSize: 12, marginTop: 5 }, modalRoot: { flex: 1 }, backdrop: { flex: 1, backgroundColor: 'rgba(0,0,0,0.48)', justifyContent: 'flex-end' }, sheet: { maxHeight: '90%', borderTopLeftRadius: 26, borderTopRightRadius: 26, paddingHorizontal: 18, paddingTop: 9, paddingBottom: 16 }, sheetContent: { paddingBottom: 14 }, handle: { width: 42, height: 4, borderRadius: 2, alignSelf: 'center', marginBottom: 17 }, sheetHeading: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 18 }, sheetTitle: { fontSize: 19, fontWeight: '900' }, sheetSubtitle: { fontSize: 11, marginTop: 3 }, close: { width: 34, height: 34, borderRadius: 12, alignItems: 'center', justifyContent: 'center' }, label: { fontSize: 12, fontWeight: '800', marginBottom: 7, marginTop: 4 }, inputWrap: { height: 47, borderWidth: 1, borderRadius: 14, paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 13 }, input: { flex: 1, height: 45, fontSize: 13 }, categoryList: { flexDirection: 'row', flexWrap: 'wrap', gap: 7, paddingBottom: 20 }, category: { minHeight: 35, borderRadius: 18, borderWidth: 1, paddingHorizontal: 13, paddingVertical: 8, alignItems: 'center', justifyContent: 'center' }, categoryText: { fontSize: 11, fontWeight: '800' }, actions: { flexDirection: 'row', gap: 10 }, clearButton: { height: 48, flex: 0.38, borderRadius: 14, borderWidth: 1, alignItems: 'center', justifyContent: 'center' }, applyButton: { height: 48, flex: 0.62, borderRadius: 14, alignItems: 'center', justifyContent: 'center' }, actionText: { fontSize: 13, fontWeight: '900' },
});
